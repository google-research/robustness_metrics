...
class ModelPredictions:
  ...
  Properties:
    element_id: A unique identifier of the example within the dataset.
    metadata: A dictionary holding the metadata of the example. What gets stored
      here is dependent on the dataset.
